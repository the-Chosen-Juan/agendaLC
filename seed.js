...
const tasks = [
  ...
  { id: crypto.randomUUID(), client: "DIAGEO", taskNumber: 2, project: "WC26 Responsible - stunt", assignee: "Nacho", supervisor: "Liso", priority: "media", deadline: "2026-02-11", status: "en progreso", owner: "Ari", comments: "" },
  { id: crypto.randomUUID(), client: "Black", taskNumber: 3, project: "Supervision ajustes Lolla", assignee: "Nacho", supervisor: "Liso", priority: "baja", deadline: "2026-02-11", status: "en progreso", owner: "Ari", comments: "" },
  { id: crypto.randomUUID(), client: "PORSCHE", taskNumber: 4, project: "Caja azul (activaciones)", assignee: "Nacho", supervisor: "Zeke", priority: "baja", deadline: "2026-02-13", status: "sin empezar", owner: "Juli Rey", comments: "" },
  ...
  // Asignado ap: 5 | Tomi
  { id: crypto.randomUUID(), client: "Alma Mora", taskNumber: 1, project: "Dia de los Enamorados", assignee: "Tomy", supervisor: "Whalys", priority: "alta", deadline: "2026-02-13", status: "en progreso", owner: "Jess", comments: "" },
  { id: crypto.randomUUID(), client: "LA COMU", taskNumber: null, project: "Contrato hasta 13/2", assignee: "Tomy", supervisor: "", priority: "", deadline: "2026-02-13", status: "en progreso", owner: "LuMos", comments: "" },
  { id: crypto.randomUUID(), client: "Red", taskNumber: null, project: "Busqueda nuevas bandas WC26", assignee: "Tomy", supervisor: "Whalys", priority: "alta", deadline: "", status: "esperando respuesta", owner: "Juan", comments: "" },
  ...
  { id: crypto.randomUUID(), client: "DIAGEO", taskNumber: 2, project: "WC26 Responsible - stunt", assignee: "Agus y Pau", supervisor: "Liso", priority: "alta", deadline: "2026-02-11", status: "en progreso", owner: "Ari", comments: "" },
  ...
  // Asignado ap: 7 | Marti
  { id: crypto.randomUUID(), client: "Black", taskNumber: 1, project: "Ajustes Lolla y OOH", assignee: "Marti", supervisor: "Nacho", priority: "alta", deadline: "2026-02-11", status: "sin empezar", owner: "Ari", comments: "" },
